...
In the future, in addition to implementing support for Cilk and Qthreads, we would like to extend the support of Taskgrind to a parallel programming model that could include GPUs. \george{Doesn't openmp already support GPUs, maybe clarify slightly?}
