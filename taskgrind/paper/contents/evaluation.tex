...
\george{So this example makes me think it might be worth mentioning compiler optimizations somewhere. I think a bunch of the race detection tools technically require turning off optimizations to ensure correct race detection, though in practice openmp compilers are dumb enough that it doesn't matter. I \emph{think technically} the compiler could in theory optimize away all the code here and just return 0.}
