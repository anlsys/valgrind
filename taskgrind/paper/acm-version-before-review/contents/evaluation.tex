...
As you can see, Taskgrind provides debug information thanks to the Valgrind framework, while ROMP does not due to a lack of support in its DBI framework (Dyninst).
