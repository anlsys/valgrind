...
void * taskgrind___builtin_new_aligned(ThreadId tid, SizeT n, SizeT align);
void * taskgrind___builtin_vec_new(ThreadId tid, SizeT n);
void * taskgrind___builtin_vec_new_aligned(ThreadId tid, SizeT n, SizeT align);
void * taskgrind_memalign(ThreadId tid, SizeT align, SizeT n);
